...
#python3 eval/create_replica_labels.py --langslam_dir ${repo_dir}/results/replica/room0/disent_result/slam_datasets/2026-07-06-19-09-54/psnr/before_opt \
...
python3 eval/evaluate_langslam.py --dataset_name room0 \
  --root_dir ${repo_dir}/results/replica/room0/disent_result/slam_datasets/2026-07-06-19-09-54/psnr/before_opt \
  --ae_ckpt_dir  ${repo_dir}/data/OnlineLanguageSplatting/Pretrained_models/single_stage_AE_disent.pth