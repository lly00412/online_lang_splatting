...
class Camera(nn.Module):
    def __init__(
        ...
        self.lang_feat_mask = lang_feat_mask
        self.coco_lang_feat = coco_lang_feat

    @staticmethod
    def init_from_dataset(dataset, idx, projection_matrix):
        gt_color, gt_depth, gt_pose, gt_lang_feat, lang_feat_mask = dataset[idx]
        return Camera(
            idx,
            gt_color,
            gt_depth,
